...
public class ChartView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (txty != null) {
            ...
            int lineWidth = (int) (SCREEN_WIDTH * 3 / 1080);
            paint1.setStrokeWidth(lineWidth);

            int textSize = (int) (SCREEN_WIDTH * 30 / 1080);

            paint.setTextSize(textSize); // 设置轴文字大小
            // 设置Y轴
            //canvas.drawLine(XPoint, YPoint - YBetween * 4 - SCREEN_HEIGHT * 35 / 1230, XPoint, YPoint, paint);
            // 设置X轴
...
*/
            ...
            canvas.drawText(txtx[0], XPoint + XBetween - XBetween / 2, YPoint + 40, paint);// x刻度0
            canvas.drawText(txtx[1], XPoint + XBetween * 2 - XBetween / 2, YPoint + 40, paint);// x刻度1
            canvas.drawText(txtx[2], XPoint + XBetween * 3 - XBetween / 2, YPoint + 40, paint);// x刻度2
            canvas.drawText(txtx[3], XPoint + XBetween * 4 - XBetween / 2, YPoint + 40, paint);// x刻度3
            canvas.drawText(txtx[4], XPoint + XBetween * 5 - XBetween / 2, YPoint + 40, paint);// x刻度4
            canvas.drawText(txtx[5], XPoint + XBetween * 6 - XBetween / 2, YPoint + 40, paint);// x刻度5
            canvas.drawText(txtx[6], XPoint + XBetween * 7 - XBetween / 2, YPoint + + 40, paint);// x刻度6
            ...
            float reduce = getHeight() / 5;

            c1y = (float) (hei * (top - Float.parseFloat(values[0])) / (top - bottom) + (YPoint - YBetween * 4)) - reduce;// 5-4.625
            c2y = (float) (hei * (top - Float.parseFloat(values[1])) / (top - bottom) + (YPoint - YBetween * 4)) - reduce;
            c3y = (float) (hei * (top - Float.parseFloat(values[2])) / (top - bottom) + (YPoint - YBetween * 4)) - reduce;
            c4y = (float) (hei * (top - Float.parseFloat(values[3])) / (top - bottom) + (YPoint - YBetween * 4)) - reduce;
            c5y = (float) (hei * (top - Float.parseFloat(values[4])) / (top - bottom) + (YPoint - YBetween * 4)) - reduce;
            c6y = (float) (hei * (top - Float.parseFloat(values[5])) / (top - bottom) + (YPoint - YBetween * 4)) - reduce;
            c7y = (float) (hei * (top - Float.parseFloat(values[6])) / (top - bottom) + (YPoint - YBetween * 4)) - reduce;

            c1x = XPoint + XBetween - XBetween / 6;
            c2x = XPoint + XBetween * 2 - XBetween / 6;
            c3x = XPoint + XBetween * 3 - XBetween / 6;
            c4x = XPoint + XBetween * 4 - XBetween / 6;
            c5x = XPoint + XBetween * 5 - XBetween / 6;
            c6x = XPoint + XBetween * 6 - XBetween / 6;
            c7x = XPoint + XBetween * 7 - XBetween / 6;
            ...
            int minR = (int) (SCREEN_WIDTH * 7 / 1080);
            int maxR = (int) (SCREEN_WIDTH * 11 / 1080);
            ...
            canvas.drawLine(c1x,c1y,c2x,c2y,paint1);
            canvas.drawLine(c2x,c2y,c3x,c3y,paint1);
            canvas.drawLine(c3x,c3y,c4x,c4y,paint1);
            canvas.drawLine(c4x,c4y,c5x,c5y,paint1);
            canvas.drawLine(c5x,c5y,c6x,c6y,paint1);
            canvas.drawLine(c6x,c6y,c7x,c7y,paint1);
            ...
            k1 = getK(c1x, c2x, c1y, c2y);
            k2 = getK(c2x, c3x, c2y, c3y);
            k3 = getK(c3x, c4x, c3y, c4y);
            k4 = getK(c4x, c5x, c4y, c5y);
            k5 = getK(c5x, c6x, c5y, c6y);
            k6 = getK(c6x, c7x, c6y, c7y);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                float x_length = Math.abs(mX - downX);
                float y_length = Math.abs(mY - downY);
    ...
    private void setPositions() {
        ...
        YBetween = height / 7;
        XBetween = width / 8;
        YScale = height * (height / metrics.heightPixels);
        XScale = width / 7;
        XScaleY = width / 7;
    }
